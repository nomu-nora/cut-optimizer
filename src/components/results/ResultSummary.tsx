          ...
          <div className="pt-6 border-t border-gray-200">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="bg-teal-50 border border-teal-200 rounded-lg p-4">
                ...
                <p className="text-3xl font-bold text-teal-900">{totalItemsFromOffcuts}</p>
                <p className="text-xs text-teal-600 mt-1">{totalItemQuantity}個分の{totalItemsFromOffcuts}個</p>
              </div>
            </div>
          </div>
        )}
